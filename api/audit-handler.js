...
function taxonomyPrompt(body) {
  ...
  return [
    ...
    "If the requested level is Level 1, return only genuinely missing L1 domains that belong directly under the selected L0 parent category. Do not return L2, L3, or L4 branches.",
...
function coveragePrompt(body) {
  ...
  return [
    ...
    "Strict scholarly audit mode: return fewer strong omissions, not a broad brainstorm.",
    "Prefer an empty items array over weak, speculative, trendy, overly broad, or merely nice-to-have suggestions.",
    "Return only established, well-documented academic subdomains, subfields, theories, models, or concepts.",
    "Every returned item must be searchable as a standard academic topic title in handbooks, encyclopedias, curricula, or major reference works.",
    ...
    "Do not return umbrella labels when the parent already covers that umbrella. Add only missing direct children at the next level.",
    "Do not use vague labels such as Advanced Topics, Modern Trends, Emerging Areas, Integrated Approaches, Special Topics, Applications, or Case Studies.",
    "Do not use phrases like theoretical aspects of, foundations of, perspectives on, approaches to, or topics in unless that phrase is the exact established field name.",
    ...
    "Set confidence to high only when the omission is clearly standard. Otherwise omit it.",
